...
export function drawOverlay(ctx: CanvasRenderingContext2D, st: OverlayState): void {
  ...
  // NB: the grid is no longer drawn here. It is painted by the renderer (#c)
  // BEHIND the strands (strand-renderer.js), so it composites under the bodies
  // like OSS instead of sitting on top of them on this overlay layer.
